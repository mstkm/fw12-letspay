...
const Login = () => {
  ...
  return(
    ...
    <div className="flex font-primary">
      ...
      {/* Right */}
      <div className="flex-[45%] bg-blue-50 md:pl-16 md:pr-40 md:py-10">
        ...
        <div className="text-center">
          <p>Don&apos;t have an account? Let&apos;s <Link href='' className="text-primary cursor-pointer hover:font-bold">Sign Up</Link></p>
        </div>
        </div>
      </div>
    </div>
